...
st.set_page_config( page_title="Dashboard de Salários na Área de Dados",
    page_icon="📊",
    layout='wide')
...
contratos_selecionados = st.sidebar.multiselect("Contrato", contratos, default=contratos)

tamanhos = sorted(df['tamanho_empresa'].unique())
tamanhos_selecionados = st.sidebar.multiselect("Tamanho da Empresa", tamanhos, default=tamanhos)
